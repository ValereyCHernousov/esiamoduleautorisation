package ScribeJava.org.scribe.builder.api;
...
public class EsiaApi extends DefaultApi20 {
    ...
    private static final String AUTHORIZE_URL = "https://esia-portal1.test.gosuslugi.ru/aas/oauth2/ac?response_type=code&client_id=%s&redirect_uri=%s";
    ...
    public OAuthService createService(OAuthConfig config) {
        return new ESiaOAuth2Service(this, config);
    }

    private class ESiaOAuth2Service extends OAuth20ServiceImpl {
        ...
        public ESiaOAuth2Service(DefaultApi20 api, OAuthConfig config) {
            super(api, config);
            this.api = api;
            this.config = config;
        }
